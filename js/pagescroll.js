...
$(document).ready(function () {
    ...
    function manageClasses() {
        ...
        $header.addClass("active-page" + currentPage);
        $navBtn.removeClass("active");
        $(".nav-control.nav-page" + currentPage).addClass("active");
    ...
    $(document).on("click", ".nav-control:not(.active)", function () {
        if (!scrolling) {
            ...
            if (Modernizr.csstransforms) {
                ...
                $header.addClass("active-page" + target);
                $navBtn.removeClass("active");
